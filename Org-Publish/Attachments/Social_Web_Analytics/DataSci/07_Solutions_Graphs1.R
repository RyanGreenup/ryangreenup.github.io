...
user = lookup_users(c("ubisoft"), token = tk)#examine all of the details for Chris Hemsworth
...
t <- get_friends("ubisoft", token = tk) #gets user id of friends of chrishemsworth
names(t)
